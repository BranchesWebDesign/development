...
if(isset($_REQUEST['contactformid']) && $_REQUEST['contactformid'] == 1){
	...
	$youremail = "ceo@brancheswebsolutions.com"; // Enter your email here!!
	...
	echo '<p>Thank you for your email, a member of our staff will contact you soon regarding your form submission!</p>';
